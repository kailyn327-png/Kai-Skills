...
```
/Users/kaibiami/marketing/image downloader agent/downloads/<client-name>/<YYYY-MM-DD>/
```
...
```bash
mkdir -p "/Users/kaibiami/marketing/image downloader agent/downloads/<client-name>/<date>"
```
...
```bash
curl -L -s -o "/Users/kaibiami/marketing/image downloader agent/downloads/<client-name>/<date>/<filename>" "<image-url>"
```
...
/Users/kaibiami/marketing/image downloader agent/downloads/<client-name>/<date>/
